  ...
  return (
    <section className="min-h-[100svh] w-full flex flex-col items-center justify-center relative py-16 sm:py-20 lg:py-32">
      ...
      <motion.div
        ...
        className="w-full text-zinc-800 dark:text-zinc-200 text-center max-w-3xl relative z-10 -mt-8 sm:-mt-12 lg:-mt-16 mx-auto rounded-2xl"
      >
        ...
        <motion.div
          ...
          text-zinc-700 dark:text-zinc-200 shadow-lg hover:shadow-xl
        ...
        >
          <h1
            ...
            bg-clip-text text-transparent bg-gradient-to-r from-zinc-800 via-zinc-600 to-zinc-400
        ...
        >
          <motion.a
            href="#projects"
            whileTap={{ scale: 0.98 }}
            className="flex-1 px-5 py-3.5 bg-zinc-900 dark:bg-white
          ...
          <motion.a
            href="#contact"
            whileTap={{ scale: 0.98 }}
            className="flex-1 px-5 py-3.5 border border-zinc-300 dark:border-zinc-700 
            text-zinc-800 dark:text-zinc-200 rounded-lg font-medium 
            flex items-center justify-center gap-2
